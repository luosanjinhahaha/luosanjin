...
//------------------trent's slider
		...
		//load bar 
		tStartLoadBar();
		$('.trent-slider1').hover(function() {$('.t-load-bar .inner-load-bar').css($t_loadBarStopStyles);}, function() {tStartLoadBar()})
		//interval sllide change
		var tSlideChange = window.setInterval(function() {
			tSlideChangerRight();
		}, 4500);
		$('.trent-slider1').mouseover(function() {
