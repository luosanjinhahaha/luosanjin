$('.conLeft li').on('click',function(){
	...
	function answers(){
		...
		var answer='';
		answer+='<li>'+
					'<div class="answerHead"><img src="medical/images/homepage_images/chat-img/20170926103645_54.jpg"/></div>'+
	...
	$('.emjon li').on('click',function(){
		...
		var str="";
		str+='<li>'+
				'<div class="nesHead"><img src="/images/homepage_images/chat-img/6.jpg"/></div>'+
